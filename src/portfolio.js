...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡Experience of building MERN (MongoDB, Express.js, React.js, Node.js) Stack application."
    ),
    emoji(
    ...
    emoji(
      "⚡Good understanding of Agile and other software development methodologies."
    ),
    emoji(
      "⚡Integration of third party services such as GoogleAPIs / ZoomAPIs / Firebase / Vimeo / SSL wireless sms APIs etc."
    ),
  ],
  ...
  experience: [
    {
      ...
      year: "Passing year - December 2018",
    },
  ],
};
